<?php
	...
	//mysql_connect("hl222.dinaserver.com","valeria1298","siproyectoSurf16"); // conexion servidor MYSQL
	...
	$resSQL=mysql_query("UPDATE valoraciones SET escuela_id=".$_REQUEST['puntos']." WHERE escuela_id=".$_REQUEST['idEscl']); // consulta SQL
